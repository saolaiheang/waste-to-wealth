...
class _RedeemPageState extends State<RedeemPage> {
  ...
  children: [
    // Image/Icon Section
    Icon(Icons.eco, color: Colors.green, size: 100), // Adjusted size
          ...
          Text(
            ...
            style: TextStyle(
              ...
              Expanded(
                child: ListView(
                  children: [
                    rewardItem(0, "Cash Voucher", "\$10", 500, Icons.attach_money),
                    rewardItem(1, "Shopping Discount", "20% OFF", 1000, Icons.percent),
                    rewardItem(2, "Free PickUp", "1 Service", 250, Icons.local_shipping),
                    rewardItem(3, "Eco-Friendly Products", "Gift Box", 750, Icons.card_giftcard),
                    rewardItem(4, "Free PickUp", "1 Service", 250, Icons.local_shipping),
                  ],
                ),
              ),
            ],
  ...
  Widget rewardItem(int index, String title, String subtitle, int points, IconData icon) {
    return Container(
